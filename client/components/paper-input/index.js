...
class PaperInput extends Component {
  ...
  render(){
    let { type, label, hint, placeholder, ref, className, validator, ...props } = this.props;
    ...
    return (
      <div className={cn}>
        {label}
        <input className={cns(className, 'paper-input-field')} ref='input' type={type} onFocus={::this.onFocus} onBlur={::this.onBlur} onChange={::this.onChange} {...props} />
